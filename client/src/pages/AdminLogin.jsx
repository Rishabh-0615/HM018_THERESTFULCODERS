...
const AdminLogin = () => {
    ...
    useEffect(() => {
        const savedEmail = localStorage.getItem('proimg_admin_email')
        if (savedEmail) {
            setEmail(savedEmail)
            setRememberMe(true)
        }
    ...
    const submitHandler = (e) => {
        ...
        if (rememberMe) {
            localStorage.setItem('proimg_admin_email', email)
        } else {
            localStorage.removeItem('proimg_admin_email')
        }
        ...
        <div className='min-h-screen flex items-center justify-center bg-[#F0F3FB]'>
            ...
            >
                <motion.div className='flex justify-center mb-4' variants={itemVariants}>
                    <div className='w-16 h-16 bg-[#055AF9] rounded-full flex items-center justify-center'>
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <motion.button 
                        ...
                        whileTap={{ scale: 0.98 }}
                    >
                        {btnLoading ? <LoadingAnimation /> : "SIGN IN AS ADMIN"}
                    </motion.button>
                </form>
