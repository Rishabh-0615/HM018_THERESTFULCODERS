                ...
                <div style={{
                  ...
                  {warnings.length > 0 && (
                    <div style={{
                      ...
                      {warnings.map((w, i) => (
                        <p key={i} style={{ color: "#856404", margin: "4px 0" }}>
                          • {w}
                        </p>
                      ))}
                    </div>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    {cartItems.map(item => (
                      ...
                      >
                        ...
                        />
                        <div style={{ flex: 1 }}>
                          <h4 style={{ color: theme.textPrimary, marginBottom: 4 }}>
                            {item.name}
                          </h4>
                        ...
                        <div style={{ 
                          ...
                          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                            ...
                            >
                              <FaMinus style={{ fontSize: 12, color: theme.textPrimary }} />
                            </button>
                            <span style={{ 
                              minWidth: 40, 
                              textAlign: "center",
                            ...
                            >
                              <FaPlus style={{ fontSize: 12, color: theme.primary }} />
                            </button>
                            <button
                              onClick={() => {
                            ...
                            >
                              <FaTrash style={{ fontSize: 12, color: theme.error }} />
                            </button>
                          </div>
                        </div>
                      </div>
                    ...
                    {["COD", "Online", "Insurance"].map(method => (
                      <label
                        ...
                        style={{
                          ...
                          gap: 12,
                          padding: 16,
                          background: paymentMethod === method ? theme.primarySoft : theme.background,
                ...
                {hasRxRequired && (
                  <div style={{
                    ...
                    <p style={{ color: theme.textSecondary, fontSize: 14, marginBottom: 16 }}>
                      Some items in your cart require a prescription. Please upload a clear image.
                    </p>
                    <input
                      type="file"
                      accept="image/*"
                    ...
                    />
                    {prescriptionFile && (
                      <p style={{ color: theme.success, fontSize: 14, marginTop: 8 }}>
            ...
            <div style={{
              ...
              <div style={{ 
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                  <span style={{ color: theme.textSecondary }}>Items ({cartItems.length})</span>
