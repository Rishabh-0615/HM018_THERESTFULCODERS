...
const AddMedicinePratik = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post('/api/pharma/medicine.pratik', formDataToSend, {
  ...
  return (
    <div className="min-h-screen bg-[#F0F3FB]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h1 className="text-4xl font-bold text-[#343838] mb-8">Add New Medicine</h1>
...
export default AddMedicinePratik;
