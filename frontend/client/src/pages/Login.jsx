  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F0F3FB]">
      ...
      >
        ...
        <motion.h2
          className="text-2xl font-bold text-[#343838] text-center mb-6"
          variants={itemVariants}
        >
          Welcome Back
        </motion.h2>
        ...
        <form onSubmit={submitHandler}>
          ...
          >
            <div className="flex items-center">
              ...
              <label
                htmlFor="remember"
                className="ml-2 block text-sm text-[#7F7E85]"
              >
                Remember me
              </label>
            </div>
            <div>
              <Link
                to="/forgot"
                className="text-sm font-medium text-[#055AF9] hover:text-[#013188] hover:underline"
              >
                Forgot password?
              </Link>
            </div>
