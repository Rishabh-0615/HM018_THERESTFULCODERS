            ...
            >
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <motion.div className='flex items-center justify-between mb-6' variants={itemVariants}>
                        ...
                        <div>
                            <Link to="/forgot" className='text-sm font-medium text-[#055AF9] hover:text-[#013188] hover:underline'>
                                Forgot password?
                            </Link>
                        </div>
                    </motion.div>
                ...
                <motion.div className='mt-6 text-center' variants={itemVariants}>
                    ...
                    <div className='text-[#7F7E85]'>
                        ...
                        <Link to="/register" className='font-medium text-[#055AF9] hover:text-[#013188] hover:underline'>
                            Create an account
                        </Link>
                    </div>
                </motion.div>
